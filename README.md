シンプルで小さなツールを作っています。  
Building simple, small tools.

## 📁 ファイル転送 / File Transfer

### ![](images/icons/droppal.png) DropPal (Web App)
▶️ **[DropPalを開く](https://nacookan.github.io/droppal/)**  
...
▶️ **[DropStandを開く](https://dropstand.nacookan.workers.dev)**  
...
### ![](images/icons/clipmo.png) Clipmo (macOS App)
軽量クリップボード履歴のmacOSアプリ。スニペット・テキスト変換・OCRに対応。  
A lightweight clipboard history app for macOS, with snippets, text transforms, and OCR.  
[github.com/nacookan/clipmo](https://github.com/nacookan/clipmo)

### ![](images/icons/runbookle.png) Runbookle (Web App)
▶️ **[Runbookleを開く](https://nacookan.github.io/runbookle/)**  
...
### ![](images/icons/memmind.png) MemMind (macOS App)
アクティビティモニタ風にメモリ使用履歴を表示するmacOSアプリ。  
A macOS app that shows memory usage history in the style of Activity Monitor.  
[github.com/nacookan/memmind](https://github.com/nacookan/memmind)

### ![](images/icons/tunnela.png) Tunnela (macOS App)
中継サーバー経由で離れた2台のMac間にSSHポートフォワーディングを構築するmacOSアプリ。  
A macOS app that sets up SSH port forwarding between two remote Macs through a relay server.  
[github.com/nacookan/tunnela](https://github.com/nacookan/tunnela)
...
### ![](images/icons/fastar.png) Fastar (macOS App)
大量の画像ファイルにレーティングを素早く付けられるmacOSアプリ。  
A macOS app for rating large sets of image files, fast.  
[github.com/nacookan/fastar](https://github.com/nacookan/fastar)
...
### ![](images/icons/cli.png) Framen (CLI Tool)
画像にさまざまなスタイルの白枠を追加するCLIツール。  
A CLI tool that adds white borders to images in a variety of frame styles.  
[github.com/nacookan/framen](https://github.com/nacookan/framen)
...
[github.com/nacookan/cameline](https://github.com/nacookan/cameline)

### ![](images/icons/softbox.png) Softbox (macOS App)
